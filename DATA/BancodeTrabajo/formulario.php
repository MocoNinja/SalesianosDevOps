...
<html lang="en">
    ...
    <body>
        ...
        <form id="formulario" action="./php/handleForm.php" method="POST">
            ...
            <input name="martes" class="fechas" type="text" id="martes" placeholder="HH:mm-HH:mm(;HH:mm-HH:mm;...)"/>
            <br />
            ...
            <input name="jueves" class="fechas" type="text" id="jueves" placeholder="HH:mm-HH:mm(;HH:mm-HH:mm;...)"/>
            <br />
